!(function () {
  ...
  null == o &&
    ...
    o.register("4Sxqp", function (t, e) {
      ...
      n.from && n.alloc && n.allocUnsafe && n.allocUnsafeSlow
        ? (t.exports = r)
        : (i(r, t.exports), (t.exports.Buffer = s)),
        i(n, s),
    ...
    o.register("cFM5c", function (e, r) {
      ...
      function d(t, e, r) {
        ...
        var i = (function (t) {
          ...
          if (void 0 !== t.length)
            return "number" != typeof t.length || Y(t.length) ? c(0) : m(t);
      ...
      function m(t) {
        for (
          var e = t.length < 0 ? 0 : 0 | w(t.length), r = c(e), n = 0;
          n < e;
          n += 1
        )
          r[n] = 255 & t[n];
      ...
      function U(t, e, r, n, i) {
        ...
        if (("string" == typeof e && (e = l.from(e, n)), l.isBuffer(e)))
          return 0 === e.length ? -1 : P(t, e, r, n, i);
        if ("number" == typeof e)
          return (
            (e &= 255),
      ...
      (a = f),
        ...
        p && (l.prototype[p] = l.prototype.inspect),
      ...
      (l.prototype.slice = function (t, e) {
        ...
        (l.prototype.readFloatLE = function (t, e) {
          return (
            (t >>>= 0), e || k(t, 4, this.length), h.read(this, t, !0, 23, 4)
          );
        }),
        (l.prototype.readFloatBE = function (t, e) {
          return (
            (t >>>= 0), e || k(t, 4, this.length), h.read(this, t, !1, 23, 4)
          );
        }),
        (l.prototype.readDoubleLE = function (t, e) {
          return (
            (t >>>= 0), e || k(t, 8, this.length), h.read(this, t, !0, 52, 8)
          );
        }),
        (l.prototype.readDoubleBE = function (t, e) {
          return (
            (t >>>= 0), e || k(t, 8, this.length), h.read(this, t, !1, 52, 8)
          );
        }),
      ...
      r(u, n),
        ...
        (u.prototype._update = function (t) {
          ...
          (this._al = (this._al + b) | 0),
            ...
            (this._ah = (this._ah + r + m(this._al, b)) | 0),
            (this._bh = (this._bh + n + m(this._bl, _)) | 0),
            (this._ch = (this._ch + i + m(this._cl, S)) | 0),
            (this._dh = (this._dh + o + m(this._dl, U)) | 0),
            (this._eh = (this._eh + a + m(this._el, P)) | 0),
            (this._fh = (this._fh + u + m(this._fl, E)) | 0),
            (this._gh = (this._gh + v + m(this._gl, A)) | 0),
            (this._hh = (this._hh + w + m(this._hl, B)) | 0);
        }),
        (u.prototype._hash = function () {
  ...
  !(function () {
      ...
      g = function (n) {
        if (
          ...
          (this.pendingFiles = {}),
            (this.queuedFiles = []),
            (this.filesInProcess = []),
            (r = new F(this.config.mockLocalStorage));
          ...
          t.aws_url
            ...
            : (t.s3Acceleration
                ? ((e = ["https://", t.bucket, ".s3-accelerate"]),
                  (t.cloudfront = !0))
                : ((e = ["https://", t.cloudfront ? t.bucket + "." : "", "s3"]),
                  "us-east-1" !== t.awsRegion && e.push("-", t.awsRegion)),
              e.push(".amazonaws.com"));
          return e.join("");
        })(this.con)),
        (this.awsHost = B(this.awsUrl).hostname);
      var r = O({}, e);
    ...
    function E(t, e) {
      (this.part = e),
        ...
        (this.start = (this.partNumber - 1) * t.con.partSize),
        (this.end = Math.min(this.partNumber * t.con.partSize, t.sizeBytes));
      var r = {
        method: "PUT",
    ...
    (g.create = function (t) {
      ...
      (g.getLocalTimeOffset = function (t) {
        return new Promise(function (r, n) {
          ...
          if (t.timeUrl) {
            ...
            i.open("GET", t.timeUrl + "?requestTime=" + new Date().getTime()),
              ...
              (i.onerror = function (t) {
                e.e("xhr error timeUrl", t),
                  n("Fetching offset time failed with status: " + t.status);
              }),
              i.send();
          } else r(0);
        });
      ...
      (g.prototype.config = {}),
      (g.prototype.localTimeOffset = 0),
      (g.prototype.supported = !1),
      (g.prototype._instantiationError = void 0),
      (g.prototype.evaporatingCount = 0),
      (g.prototype.pendingFiles = {}),
      (g.prototype.filesInProcess = []),
      (g.prototype.queuedFiles = []),
      (g.prototype.startNextFile = function (t) {
        if (
      ...
      (g.prototype.fileCleanup = function (t) {
        z(this.queuedFiles, t),
          z(this.filesInProcess, t) && this.evaporatingCnt(-1),
          t.done(),
          this.consumeRemainingSlots();
      }),
      (g.prototype.queueFile = function (t) {
        this.filesInProcess.push(t),
          this.queuedFiles.push(t),
          1 === this.filesInProcess.length && this.startNextFile("first file");
      }),
      (g.prototype.add = function (t, e) {
        ...
        return new Promise(function (i, o) {
          ...
          (n.pendingFiles[f] = p),
            n.queueFile(p),
            p.deferredCompletion.promise.then(
              function () {
      ...
      (g.prototype._cancelAll = function () {
        ...
        return (
          t.length || t.push(Promise.reject("No files to cancel.")),
          Promise.all(t)
        );
      }),
      (g.prototype._cancelOne = function (t) {
        ...
        return (
          this.pendingFiles[t]
            ...
            : e.push(Promise.reject("File does not exist")),
          Promise.all(e)
        );
      }),
      ...
      (g.prototype.forceRetry = function () {}),
      (g.prototype.consumeRemainingSlots = function () {
      ...
      (g.prototype.evaporatingCnt = function (t) {
        (this.evaporatingCount = Math.max(0, this.evaporatingCount + t)),
          this.config.evaporateChanged(this, this.evaporatingCount);
      }),
      (m.prototype.con = void 0),
      (m.prototype.evaporate = void 0),
      (m.prototype.localTimeOffset = 0),
      (m.prototype.id = void 0),
      (m.prototype.status = 0),
      (m.prototype.numParts = -1),
      (m.prototype.fileTotalBytesUploaded = 0),
      (m.prototype.partsInProcess = []),
      (m.prototype.partsToUpload = []),
      (m.prototype.s3Parts = []),
      (m.prototype.partsOnS3 = []),
      (m.prototype.deferredCompletion = void 0),
      (m.prototype.abortedByUser = !1),
      (m.prototype.progressInterval = void 0),
      (m.prototype.startTime = void 0),
      (m.prototype.loaded = 0),
      (m.prototype.totalUploaded = 0),
      (m.prototype.updateLoaded = function (t) {
      ...
      (m.prototype.getRemainingSlots = function () {
        ...
        return (
          !this.partsInProcess.length && t > 0 && (t -= 1),
          this.con.maxConcurrentParts - t
        );
      }),
      (m.prototype.lastPartSatisfied = Promise.resolve("onStart")),
      ...
      (m.prototype.stop = function () {
        e.d("stopping FileUpload ", this.id),
          this.setStatus(s),
      ...
      (m.prototype.makeParts = function (t) {
        ...
        var e = [],
          r = this;
        function n(t) {
          z(r.partsToUpload, t.partNumber),
            z(r.partsInProcess, t.partNumber),
            r.partsToUpload.length && r.evaporatingCnt(-1);
        }
        function i(t) {
          return function () {
            n(t),
              r.partsToUpload.length && r.consumeRemainingSlots(),
              r.partsToUpload.length < r.con.maxConcurrentParts &&
        ...
        for (var s = t ? 1 : this.numParts, a = 1; a <= s; a++) {
          ...
          (u.awsRequest = new E(this, u)),
            u.awsRequest.awsDeferred.promise.then(i(u), o(u)),
            this.partsToUpload.push(a),
            e.push(this.s3Parts[a].awsRequest.awsDeferred.promise);
        }
        return e;
      }),
      ...
      (m.prototype.completeUploadFile = function (t) {
        ...
        void 0 !== n &&
          ...
          this.complete(t, this.name, this.progessStats()),
          this.setStatus(3),
          this.onProgress();
      }),
        ...
        -1 !== c.indexOf(this.status) &&
          ...
          this.partsOnS3.forEach(
            function (t) {
              ...
              (e.eTag = t.eTag),
                (e.loadedBytes = t.size),
                (e.loadedBytesPrevious = t.size),
                (e.finishedUploadingAt = t.LastModified);
            }.bind(this)
          ));
      }),
      (m.prototype.completeUpload = function () {
        ...
        return new S(this).send().then(function (e) {
          (t.eTag = T(e.responseText, "ETag").replace(/&quot;/g, '"')),
      ...
      (m.prototype.getCompletedPayload = function () {
        var t = [];
        return (
          t.push("<CompleteMultipartUpload>"),
          this.s3Parts.forEach(function (e, r) {
            r > 0 &&
              [
                "<Part><PartNumber>",
                r,
          ...
          for (var e = 0, r = 0; r < this.partsToUpload.length; r++) {
            ...
            if (n.status !== i && this.canStartPart(n)) {
              this.partsInProcess.length &&
                ...
                this.evaporatingCnt(1),
                this.partsInProcess.push(n.partNumber);
              var o = n.awsRequest;
              if (
        ...
        return n.awsRequest.getPartMd5Digest().then(function () {
          if (r.firstMd5Digest === n.md5_digest)
            return new U(r, t)
              .send()
              .then(function (t) {
                e.d("headObject found matching object on S3."),
                  r.completeUploadFile(t),
                  r.nameChanged(r.name);
              })
              .catch(i);
          i(
      ...
      (v.prototype.fileUpload = void 0),
      (v.prototype.con = void 0),
      (v.prototype.awsUrl = void 0),
      (v.prototype.awsHost = void 0),
      (v.prototype.authorize = function () {}),
      (v.prototype.localTimeOffset = 0),
      (v.prototype.awsDeferred = void 0),
      (v.prototype.started = void 0),
      (v.prototype.getPath = function () {
        var t = "/" + this.con.bucket + "/" + this.fileUpload.name;
        return (
          (this.con.cloudfront || this.awsUrl.indexOf("cloudfront") > -1) &&
            (t = "/" + this.fileUpload.name),
          t
        );
      }),
      (v.prototype.updateRequest = function (t) {
        ...
        var r = (function (t, e) {
          ...
          return (
            ...
            (n.prototype.authorizationString = function () {}),
            (n.prototype.stringToSign = function () {}),
            (n.prototype.canonicalRequest = function () {}),
            (n.prototype.setHeaders = function () {}),
            (n.prototype.datetime = function (t) {
            ...
            (o.prototype._cr = void 0),
            (o.prototype.payload = null),
            ...
            (o.prototype.authorizationString = function () {
              ...
              return (
                ...
                t.push("SignedHeaders=" + n.signedHeaders),
            ...
            (o.prototype.stringToSign = function () {
              ...
              t.push("AWS4-HMAC-SHA256"),
                t.push(this.request.dateString),
                t.push(this.credentialString()),
            ...
            (o.prototype.credentialString = function () {
              var t = [];
              return (
                t.push(this.request.dateString.slice(0, 8)),
                t.push(r.awsRegion),
                t.push("s3"),
                t.push("aws4_request"),
                t.join("/")
            ...
            (o.prototype.canonicalHeaders = function () {
              ...
              this.request.md5_digest &&
                i("Content-Md5", this.request.md5_digest),
                i("Host", t.awsHost),
                this.request.contentType &&
            ...
            (o.prototype.canonicalRequest = function () {
              ...
              return (
                r.push(n.canonicalHeaders + "\n"),
                r.push(n.signedHeaders),
                r.push(this.getPayloadSha256Content()),
                (this._cr = r.join("\n")),
                e.d(this.request.step, "V4 CanonicalRequest:", this._cr),
                this._cr
              );
            }),
      ...
      (v.prototype.error = function (t) {
        if (
          ...
          this.fileUpload.warn("Error in ", this.request.step, t),
      ...
      (v.prototype.errorHandler = function () {}),
      (v.prototype.errorExceptionStatus = function () {
        return !1;
      }),
      ...
      (v.prototype.sendRequestToAWS = function () {
        ...
        return new Promise(function (e, r) {
          ...
          var i = [
            ...
            o = {};
          for (var s in (t.request.query_string &&
            (i += t.request.query_string),
          O(o, t.request.not_signed_headers),
          O(o, t.request.x_amz_headers),
          ...
          t.signer.setHeaders(n),
            t.request.contentType &&
              n.setRequestHeader("Content-Type", t.request.contentType),
            t.request.md5_digest &&
              n.setRequestHeader("Content-MD5", t.request.md5_digest),
            (n.onerror = function (t) {
              var e = t.responseText ? x(t) : "transport error";
              r(e);
            }),
            "function" == typeof t.request.onProgress &&
              (n.upload.onprogress = t.request.onProgress),
            t.getPayload().then(n.send.bind(n), r),
            setTimeout(function () {
              t.started.resolve("request sent " + t.request.step);
            }, 20),
            (t.signer.payload = null),
            (t.payloadPromise = void 0);
        });
      }),
      (v.prototype.authorize = function () {
        return (
          (this.request.dateString = this.signer.dateString(
            this.localTimeOffset
          )),
          (this.request.x_amz_headers = O(this.request.x_amz_headers, {
            ...
            function () {
              return (function (t) {
                ...
                return (
                  ...
                  (i.prototype.request = {}),
                  (i.makeSignParamsObject = function (t) {
                    var e = {};
                    for (var r in t)
                      t.hasOwnProperty(r) &&
                        ("function" == typeof t[r]
                  ...
                  (i.prototype.authorize = function () {
                    return new Promise(function (o, s) {
                      ...
                      r.xhrWithCredentials && (a.withCredentials = !0),
                        (a.onreadystatechange = function () {
                          if (4 === a.readyState)
                            if (200 === a.status)
                              t.signResponse(a.response, u, n.dateString).then(
                                o
                              );
                            else {
                        ...
                        (a.onerror = function (t) {
                          s(
                            "authorizedSend transport error: " + t.responseText
                          );
                        }),
                        a.open("GET", h);
      ...
      (v.prototype.trySend = function () {
        ...
        return this.authorize().then(function (e) {
          t.authorizationSuccess(e),
            t.fileUpload.status !== u &&
              t.sendRequestToAWS().then(t.success.bind(t), t.error.bind(t));
        }, t.error.bind(t));
      }),
      ...
      (w.prototype.errorExceptionStatus = function () {
        return [u, s].indexOf(this.fileUpload.status) > -1;
      }),
      (b.prototype = Object.create(w.prototype)),
      (b.prototype.constructor = b),
      (b.prototype.maxRetries = 1),
      (b.prototype.errorHandler = function (t) {
      ...
      (_.prototype.success = function () {
        var t = this.currentXhr.response.match(
          new RegExp(this.request.response_match)
        );
        (this.fileUpload.uploadId = t[1]),
          (this.fileUpload.awsKey = this.awsKey),
          e.d("InitiateMultipartUpload ID is", this.fileUpload.uploadId),
      ...
      (P.prototype.awsKey = void 0),
      (P.prototype.partNumberMarker = 0),
      (P.prototype.setupRequest = function (t) {
        var r = [
        ...
        e.d(r),
          this.fileUpload.info(r),
          (this.awsKey = this.fileUpload.name),
          (this.partNumberMarker = t);
        var n = {
          method: "GET",
      ...
      (E.prototype.part = 1),
      (E.prototype.payloadPromise = void 0),
      (E.prototype.start = 0),
      (E.prototype.end = 0),
      (E.prototype.partNumber = void 0),
      (E.prototype.getPartMd5Digest = function () {
        var t = this,
          r = this.part;
      ...
      (E.prototype.sendRequestToAWS = function () {
        return (
          (this.stalledInterval = setInterval(this.stalledPartMonitor(), l)),
          this.stalledPartMonitor(),
          v.prototype.sendRequestToAWS.call(this)
        );
      }),
      ...
      (E.prototype.success = function () {
        ...
        (this.currentXhr = null),
          this.fileUpload.partSuccess(t, this) &&
            this.awsDeferred.resolve(this.currentXhr);
      }),
      (E.prototype.onProgress = function (t) {
        if (t.loaded > 0) {
          ...
          e &&
            ((this.part.loadedBytes = t.loaded),
            this.fileUpload.updateLoaded(e));
        }
      }),
      (E.prototype.stalledPartMonitor = function () {
        var t = this.part.loadedBytes,
          r = this;
        return function () {
          clearInterval(r.stalledInterval),
            -1 === [i, a, p, o].indexOf(r.fileUpload.status) &&
              r.part.status !== u &&
      ...
      (E.prototype.errorHandler = function (t) {
        if ((clearInterval(this.stalledInterval), t.match(/status:404/))) {
          var r =
            "404 error on part PUT. The part and the file will abort. " + t;
          return (
            e.w(r),
            this.fileUpload.error(r),
            (this.part.status = u),
            this.awsDeferred.reject(r),
            !0
          );
        }
        return (
          ...
          (this.part.status = a),
          this.errorExceptionStatus() || this.delaySend(),
          !0
        );
      }),
      ...
      (E.size = 0),
      (E.prototype.streamToArrayBuffer = function (t) {
        return new Promise(
          function (e, r) {
      ...
      (E.prototype.stalledInterval = -1),
      (E.prototype.getStartedPromise = function () {
        return this.started.promise;
      }),
      (A.prototype = Object.create(v.prototype)),
      (A.prototype.constructor = A),
      (A.prototype.maxRetries = 1),
      ...
      (A.prototype.errorHandler = function (t) {
        if (this.attempts > this.maxRetries) {
          var r =
            ...
            t;
          return (
            e.w(r), this.fileUpload.error(r), this.awsDeferred.reject(r), !0
          );
        }
      }),
      (F.prototype.supported = !1),
      (F.prototype.cacheStore = void 0),
  ...
  !(function (t) {
    ...
    return (
      ...
      (p.ArrayBuffer.prototype.append = function (t) {
        var e,
          ...
          u =
            ...
            (o = t),
            (s = !0),
            (a = new Uint8Array(n.byteLength + o.byteLength)).set(
              new Uint8Array(n)
            ),
            a.set(new Uint8Array(o), n.byteLength),
            s ? a : a.buffer),
          h = u.length;
        for (this._length += t.byteLength, e = 64; e <= h; e += 64)
          r(this._hash, i(u.subarray(e - 64, e)));
        return (
          (this._buff =
            e - 64 < h
              ? new Uint8Array(u.buffer.slice(e - 64))
              : new Uint8Array(0)),
          this
        );
      }),
      ...
      (p.ArrayBuffer.prototype.getState = function () {
        var t,
          e = p.prototype.getState.call(this);
        return (
          (e.buff =
            ((t = e.buff), String.fromCharCode.apply(null, new Uint8Array(t)))),
          e
        );
      }),
  ...
  const f = (t, e, r, n, i, o) => {
    ...
    l = (t, e) => {
      (t.className = "s3direct form-active"),
        (t.querySelector(".file-input").value = ""),
        alert(e);
    };
  let d = 0;
  const y = (t) => {
    ...
    g = (t, e, r, n) => {
      ...
      (o.value = e + "/" + r + "/" + n),
        i.setAttribute("href", o.value),
        (i.innerHTML = ((t) =>
          decodeURIComponent((t + "").replace(/\+/g, "%20")))(o.value)
          .split("/")
          .pop()),
        (t.className = "s3direct link-active"),
        (t.querySelector(".bar").style.width = "0%"),
        y(!1);
    },
    ...
    b = (t, e, r) => {
      ...
      return (
        t && (n["x-amz-acl"] = t),
        r && (n["x-amz-security-token"] = r),
        e && (n["x-amz-server-side-encryption"] = e),
        n
      );
    },
    _ = (t) => {
    ...
    U = (t, r, n, i, o) => {
      const s = {
        ...
        u = {};
      n.cache_control && (u["Cache-Control"] = n.cache_control),
        n.content_disposition &&
          (u["Content-Disposition"] = n.content_disposition),
        (a.notSignedHeadersAtInitiate = u),
        e(h)
          .create(s)
          .then((e) => {
    ...
    E = (t) => {
      t.preventDefault();
      const e = t.target.parentElement;
      (e.querySelector(".file-url").value = ""),
        (e.querySelector(".file-input").value = ""),
